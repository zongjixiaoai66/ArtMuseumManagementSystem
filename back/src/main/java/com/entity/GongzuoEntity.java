...
public class GongzuoEntity<T> implements Serializable {
    ...
    @TableField(value = "gongzuo_uuid_number")

    private String gongzuoUuidNumber;
	 ...
	 * 获取：工作人员编号
	 */
    public String getGongzuoUuidNumber() {
        return gongzuoUuidNumber;
    }
    /**
	 * 设置：工作人员编号
	 */

    public void setGongzuoUuidNumber(String gongzuoUuidNumber) {
        this.gongzuoUuidNumber = gongzuoUuidNumber;
    }
    /**
	 * 获取：工作人员姓名
	 */
    ...
    public String toString() {
        return "Gongzuo{" +
            ...
            ", username=" + username +
            ", password=" + password +
            ", gongzuoUuidNumber=" + gongzuoUuidNumber +

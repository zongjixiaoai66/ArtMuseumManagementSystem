    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="艺术类型" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="艺术类型" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="艺术类型" prop="indexName">
                            <el-input v-model="ruleForm.indexName"

<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='gongzuo'"  label='工作人员编号' prop="gongzuoUuidNumber">
               <el-input v-model="ruleForm.gongzuoUuidNumber"disabled="true"   placeholder='工作人员编号' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
           <el-form-item v-if="flag=='gongzuo'"  label='工作人员姓名' prop="gongzuoName">
               <el-input v-model="ruleForm.gongzuoName"  placeholder='工作人员姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         <el-col :span="12">
...
// 注册表 工作人员 的级联表
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.gongzuoUuidNumber)&& 'gongzuo'==this.flag){
